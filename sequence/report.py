...
#log_phase
input_file = 'C:/Users/arass/OneDrive/ドキュメント/GitHub/cansat2023/kari/cansat2023/sequence/log/phaselog.txt'
start_line = 1
extract_and_write(input_file, output_file, start_line)
print("5")
...
#log_release
input_file = 'C:/Users/arass/OneDrive/ドキュメント/GitHub/cansat2023/kari/cansat2023/sequence/log/releaselog.txt'
start_line = 1
extract_and_write(input_file, output_file, start_line)
print("7")

#log_landing
input_file = 'C:/Users/arass/OneDrive/ドキュメント/GitHub/cansat2023/kari/cansat2023/sequence/log/landinglog.txt'
start_line = 1
extract_and_write(input_file, output_file, start_line)
print("8")

#log_melting
input_file = 'C:/Users/arass/OneDrive/ドキュメント/GitHub/cansat2023/kari/cansat2023/sequence/log/meltinglog.txt'
start_line = 1
extract_and_write(input_file, output_file, start_line)
print("9")

#log_para
input_file = 'C:/Users/arass/OneDrive/ドキュメント/GitHub/cansat2023/kari/cansat2023/sequence/log/para_avoid_log.txt'
start_line = 1
extract_and_write(input_file, output_file, start_line)
print("10")

#log_gpsrunning1
input_file = 'C:/Users/arass/OneDrive/ドキュメント/GitHub/cansat2023/kari/cansat2023/sequence/log/gpsrunning1log.txt'
start_line = 1
extract_and_write(input_file, output_file, start_line)
print("11")

#log_humandetect
input_file = 'C:/Users/arass/OneDrive/ドキュメント/GitHub/cansat2023/kari/cansat2023/sequence/log/humandetectlog.txt'
start_line = 1
extract_and_write(input_file, output_file, start_line)
print("12")

#log_gpsrunning2
input_file = 'C:/Users/arass/OneDrive/ドキュメント/GitHub/cansat2023/kari/cansat2023/sequence/log/gpsrunning2log.txt'
start_line = 1
extract_and_write(input_file, output_file, start_line)
print("13")

#log_photorunning
input_file = 'C:/Users/arass/OneDrive/ドキュメント/GitHub/cansat2023/kari/cansat2023/sequence/log/photorunninglog.txt'
start_line = 1
extract_and_write(input_file, output_file, start_line)
print("14")