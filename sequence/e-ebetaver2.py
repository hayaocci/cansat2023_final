...
######--------------run1--------------######
    ...
    goal_distance = PID.drive(lon_dest=lon_goal, lat_dest=lat_goal, thd_distance=10, t_run=60, log_path=log_gpsrunning2,t_start=t_start)
...
######--------------run2--------------######
    ...
    goal_distance = PID.drive(lon_dest=lon_goal, lat_dest=lat_goal, thd_distance=10, t_run=50, log_path=log_gpsrunning2,t_start=t_start)
    print(f'-----distance: {goal_distance}-----')
